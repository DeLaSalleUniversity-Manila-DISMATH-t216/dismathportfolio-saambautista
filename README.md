...
<LI> Modeling Computation
      - Grammars - generate the words of a language and determine whether a word is in a language
      - Language - generated by grammars; provides model for both natural language
